...
| Generated Stage 2 demo corpus | available | `gift64-stage2-key-corpus/v1`; domain-separated SHA-256 counter generator, tracked eight-key smoke request and tracked 1,000-key formal-demo request | Controlled fixed-key demonstration | Keep generated corpus/result files out of Git and retain `generated-for-demo` label |
